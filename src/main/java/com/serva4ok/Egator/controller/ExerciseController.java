...
public class ExerciseController {
    ...
    @PostMapping
    public String add(@RequestParam String text,@RequestParam String tag,@RequestParam String nomer,Map<String,Object> model){
        Exercise exercise = new Exercise(text,tag,nomer);
